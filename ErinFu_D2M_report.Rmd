...
knitr::kable(regression_table, format = "markdown", align = "c", caption = "E&M Regression Table", label = "regression-table") %>%
...
## Descriptive analysis: Demographic data (gender/age/race)
