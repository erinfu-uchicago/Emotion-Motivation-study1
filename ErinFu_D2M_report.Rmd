...
The distribution of learning motivation levels in different emotional conditions is showed in Figure \@ref(fig:emotion-motivation). The shape of the distribution indicates children tend to report higher learning motivation when they are shown positive emotional facial expressions from adults, and lower when they see negative emotional facial expressions from adults towards a subject. The black points demonstrate the mean value of learning motivation for each emotional condition.
